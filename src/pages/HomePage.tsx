...
const HomePage = ({ profile, selectedDate, onSelectDate, dayLog, calorieHistory, weightHistory }: HomePageProps) => {
  ...
  const weekData = Array.from({ length: 7 }, (_, i) => {
    ...
    return {
      day: dayName,
      calories: isToday ? dayLog.calories : (entry?.calories || 0),
